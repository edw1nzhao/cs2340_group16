 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Benjamin Faught");
		  toPrint += p1.toString("bfaught3");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Tomonari Feehan");
		  toPrint += p2.toString("tfeehan3");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Justin So");
		  toPrint += p3.toString("jso35");
          ...
          Person5 p5 = new Person5("Edwin Zhao");
          toPrint += p5.toString("ezhao7");
